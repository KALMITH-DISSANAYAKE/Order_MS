...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BranchId).HasName("PK__branch__E55E37DE24FCE5DB");

            entity.ToTable("branch");

            entity.HasIndex(e => e.BranchCode, "UQ__branch__A9F83E3BCB3011E0").IsUnique();
        ...
        {
            entity.HasKey(e => e.DriverId).HasName("PK__driver__A411C5BD27BF8DE8");

            entity.ToTable("driver");

            entity.HasIndex(e => e.LicenseNumber, "UQ__driver__D482A0037493E201").IsUnique();
        ...
        {
            entity.HasKey(e => e.ConnectionId).HasName("PK__driver_v__E4AA4DD0ED577FBD");
        ...
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__inventor__B59ACC498A96E266");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__item__52020FDD19B99DE4");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__465962291A6F2023");
        ...
        {
            entity.HasKey(e => e.OrderlineId).HasName("PK__order_li__053FF2120831BAE1");
        ...
        {
            entity.HasKey(e => e.OrderReqId).HasName("PK__order_re__0CF367CB4DDA2ECD");
        ...
        {
            entity.HasKey(e => e.OrderReqLineId).HasName("PK__order_re__7C549BF1F3827055");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__role__760965CCE672CE21");

            entity.ToTable("role");

            entity.HasIndex(e => e.RoleName, "UQ__role__783254B1973A2499").IsUnique();
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__supplier__6EE594E8222E91C0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__user__3213E83F8F15BFE1");

            entity.ToTable("user");

            entity.HasIndex(e => e.UserName, "UQ__user__7C9273C4CF30F49E").IsUnique();
        ...
        {
            entity.HasKey(e => e.VehicalId).HasName("PK__vehicle__6E8871A0EC8B00A8");

            entity.ToTable("vehicle");

            entity.HasIndex(e => e.VehicalNumber, "UQ__vehicle__2294CA0A7273DADA").IsUnique();
