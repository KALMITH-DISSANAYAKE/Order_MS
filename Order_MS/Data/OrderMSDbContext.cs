...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Branch>(entity =>
        {
            entity.HasKey(e => e.BranchId).HasName("PK__branch__E55E37DE002DEA17");

            entity.ToTable("branch");

            entity.HasIndex(e => e.BranchCode, "UQ__branch__A9F83E3B0D490770").IsUnique();
        ...
        modelBuilder.Entity<Driver>(entity =>
        {
            entity.HasKey(e => e.DriverId).HasName("PK__driver__A411C5BDBC554F07");

            entity.ToTable("driver");

            entity.HasIndex(e => e.LicenseNumber, "UQ__driver__D482A0033F119686").IsUnique();
        ...
        modelBuilder.Entity<DriverVehicleLink>(entity =>
        {
            entity.HasKey(e => e.ConnectionId).HasName("PK__driver_v__E4AA4DD0CBACCF63");
        ...
        modelBuilder.Entity<Inventory>(entity =>
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__inventor__B59ACC49D4B01155");
        ...
        modelBuilder.Entity<Item>(entity =>
        {
            entity.HasKey(e => e.ItemId).HasName("PK__item__52020FDDB9C58FF9");
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229C7EA56A4");
        ...
        modelBuilder.Entity<OrderLine>(entity =>
        {
            entity.HasKey(e => e.OrderlineId).HasName("PK__order_li__053FF212D19841D4");
        ...
        modelBuilder.Entity<OrderRequest>(entity =>
        {
            entity.HasKey(e => e.OrderReqId).HasName("PK__order_re__0CF367CB48F1D24A");
        ...
        modelBuilder.Entity<OrderRequestLine>(entity =>
        {
            entity.HasKey(e => e.OrderReqLineId).HasName("PK__order_re__7C549BF191DDD128");
        ...
        modelBuilder.Entity<Role>(entity =>
        {
            entity.HasKey(e => e.RoleId).HasName("PK__role__760965CC2B1EB963");

            entity.ToTable("role");

            entity.HasIndex(e => e.RoleName, "UQ__role__783254B143667072").IsUnique();
        ...
        modelBuilder.Entity<Supplier>(entity =>
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__supplier__6EE594E8A4633E10");
        ...
        modelBuilder.Entity<TransportAssignment>(entity =>
        {
            entity.HasKey(e => e.AssignmentId).HasName("PK__Transpor__DA8918149B6DD58D");
            ...
            entity.HasOne(d => d.OrderReq).WithMany(p => p.TransportAssignments)
                .HasForeignKey(d => d.OrderReqId)
                .HasConstraintName("FK_TransportAssignment_OrderRequest");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__user__3213E83FADDBB673");

            entity.ToTable("user");

            entity.HasIndex(e => e.UserName, "UQ__user__7C9273C4725E1DD1").IsUnique();
        ...
        modelBuilder.Entity<Vehicle>(entity =>
        {
            entity.HasKey(e => e.VehicalId).HasName("PK__vehicle__6E8871A0444EFAD7");

            entity.ToTable("vehicle");

            entity.HasIndex(e => e.VehicalNumber, "UQ__vehicle__2294CA0A428CC4AE").IsUnique();
